    ...
    <div class="filters" style="display:none" id="filter">
      ...
      <div class="form-inline">
        ...
        <div class="form-group ">
          <select class="form-control" style="width:60%; margin-left:30px;" id="rollornot">
...
dumres=Home.filter_and_search_res_mattress("", "", "",name_search);
...
<!--       <!-- one-content
      <div class="single-content">
        <div style="width:100%; padding-top:50px" class="form-inline">
          <div style="width:40%; height:250px">
            <img style="width:80%; height:250px; border-radius:10px;" src="images/mattress.jpg" alt="">
          </div>
          <div style="width:60%;" >
            <h3>Shree Sugandh Soft Cotton Mattress</h3>
      ...
      <div class="single-content">
        <div style="width:100%; height:300px; padding-top:50px" class="form-inline">
          <div style="width:40%; height:250px">
            <img style="width:80%; height:250px; border-radius:10px;" src="images/mattress2.jpg" alt="">
          </div>
          <div style="width:60%; height:250px;" >
            <h3>Sleepwell Ultra Bonded Foam Mattress</h3>
  ...
  //	 alert("hello");
  	//
  	  ...
  	  var roll=document.getElementById("rollornot").value;
      ...
      var url="filterres.jsp?category=Mattress&price="+price+"&used="+used+"&roll="+roll+"&name_search="+name_search;
       //alert(url);
