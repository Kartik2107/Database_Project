      ...
      <div class="form-inline">
        <div style="width:70%; float:left; padding-bottom:25px">
          ...
          <div class="form-group" style="float:left">
            <select class="form-control" style="width:100%; margin-left:30px;" id="acad">
              <option value="" required selected>Category</option>
          ...
          <div class="form-group" style="float:left">
            <select class="form-control" style="width:100%; margin-left:30px;" id="branch">
              <option value="" required selected>Branch</option>
          ...
          <div class="form-group" style="float:left;">
            <select class="form-control" style="width:100%; margin-left:30px;" id="year">
              <option value="" required selected>Academic year</option>
...
String name_search=request.getParameter("country");
	...
	dumres=Home.filter_and_search_res_books("", "", "", "", "",name_search);
...
%>
<!--       <!-- one-content
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto; height:250px; border-radius:10px;" src="images/book1.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>The Alchemist by Paulo Coelho</h3>
          <b>Seller</b> : <a href="#">Aman Jaiswal</a><br><br>
          <b>Type</b> : Non-academic<br>
      ...
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto%; height:250px; border-radius:10px;" src="images/book2.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>An Introduction to Programming through C++</h3>
          <b>Seller</b> : <a href="#">Namit Bhardwaj</a><br><br>
          <b>Type</b> : Academic<br>
          <b>Branch</b> : CSE<br>
          <b>Academic Year</b> : 1st Year<br>
 ...
 --> 
  ...
  //	 alert("hello");
    ...
    var acad=document.getElementById("acad").value;
      ...
      var url="filterres.jsp?category=Book&price="+price+"&used="+used+"&branch="+branch+"&acad="+acad+"&year="+year+"&name_search="+name_search;
       //alert(url);
