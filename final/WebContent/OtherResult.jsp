...
<script>
  ...
  <div>
    <div class="heading">
      <center>STATIONARY AND OTHERS</center>
    </div>
...
dumres=Home.filter_and_search_res_others("", "",name_search);
    ...
    <!--    one-content
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto; height:250px; border-radius:10px;" src="images/other.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>Nayasa Square Ring 25 Funk Bucket </h3>
          <b>Seller</b> : <a href="#">Aman Jaiswal</a><br><br>
          <b>Quantity/Units</b> : 2<br>
          <b>Used/Purchased On</b> : 15/03/2020<br><br>
      ...
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto%; height:250px; border-radius:10px;" src="images/other2.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>Pilot V7 Hi-tecpoint Pen</h3>
          <b>Seller</b> : <a href="#">Namit Bhardwaj</a><br><br>
          <b>Quantity/Unit</b> : 5<br>
          <b>Used/Purchased On</b> : 16/08/2020<br><br>
