  ...
  <div>
    ...
    <div class="sorts" style="display:none" id="sort">
      ...
      <div class="form-inline">
                ...
                <div style="width:35%; float:left">
                  <center>Time before Expiry<br>
                    <input type="radio" value="n2o" name="used"> Less to More </input><br>
                    <input type="radio" value="o2n" name="used"> More to Less </input><br><br>
                  </center>
                </div>
...
dumres=Home.filter_and_search_res_Food("", "",name_search);
...
<!--       one-content
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto; height:250px; border-radius:10px;" src="images/food.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>Haldiram's Bhujia Sev</h3>
          <b>Seller</b> : <a href="#">Aman Jaiswal</a><br><br>
          <b>Quantity/Units</b> : 2<br>
          <b>Expiry Date</b> : 15/03/2020<br><br>

          <font size="5"><b>Price</b> : Rs. 500</font>
      ...
      <div style="width:100%; height:300px; padding-top:50px; margin-left:100px" class="form-inline">
        <div style="width:30%; height:250px">
          <img style="width:auto%; height:250px; border-radius:10px;" src="images/food1.jpg" alt="">
        </div>
        <div style="width:60%; height:250px;" >
          <h3>Pringles Potato Chips, Original</h3>
          <b>Seller</b> : <a href="#">Namit Bhardwaj</a><br><br>
          <b>Quantity/Unit</b> : 5<br>
          <b>Expiry Date</b> : 16/08/2020<br><br>

          <font size="5"><b>Price</b> : Rs. 476</font>
          <button class="view-more">View More</button>
        </div>
      </div>
      content ends
 -->
  ...
  //	 alert("hello");
      ...
      var url="filterres.jsp?category=Food&price="+price+"&used="+used+"&name_search="+name_search;
       //alert(url);
