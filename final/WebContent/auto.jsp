...
<form autocomplete="off" action="/action_page.php">
  <div class="autocomplete" style="width:300px;">
    <input id="myInput" type="text" name="myCountry" onplaceholder="Country" onkeypress="sendAut()">
  </div>
  <input type="submit">
</form>
...
function getAut(){
	...
	var countries1 = ["Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla"];
	...
	autocomplete(document.getElementById("myInput"),str_array);
	}
}
