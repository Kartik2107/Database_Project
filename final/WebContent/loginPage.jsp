				...
				<div class="tabs">
					<ul class="nav nav-pills my-4 justify-content-center my-lg-5 my-3" id="pills-tab" role="tablist">
						...
						<li class="nav-item" style="padding-left:8px">
							<a class="nav-link" id="pills-edit-tab" data-toggle="pill" href="#pills-mattress" role="tab" aria-controls="pills-profile"
									aria-selected="false">Mattress</a>
						</li>
						<li class="nav-item" style="padding-left:8px">
							<a class="nav-link" id="pills-edit-tab" data-toggle="pill" href="#pills-books" role="tab" aria-controls="pills-profile"
									aria-selected="false">Books</a>
						</li>
						<li class="nav-item" style="padding-left:8px">
							<a class="nav-link" id="pills-edit-tab" data-toggle="pill" href="#pills-others" role="tab" aria-controls="pills-profile"
									aria-selected="false">Stationary & Others</a>
						</li>

					</ul>

					<div class="tab-content" id="pills-tabContent">
					<!--  categor electronics starts -->
...
%>
	<%
		List<item_details> l_elec=Home.top_hits_electronics();
	...
	%>
								...
								<!-- content -->
<%  // for 
	System.out.println(l_elec.size());								
	for(int i=1;i<=l_elec.size();i++){
		item_details obj=l_elec.get(i-1);
		
		
		out.println("<div class=\"col-lg-4 text-info-sec\">");
		out.println("	<div class=\"card\" style=\"width:355px\"> ");
		out.println("		<div class=\"card-body\" style=\"height:500px;\"> ");
		out.println("			<div style=\"height:300px; vertical-align:middle; position:relative\">");
		out.println("				<img src='data:image/jpeg;base64,"+obj.get_product_image()+"' style=\"width:auto; top:0; bottom:0; left:0; right:0; position:absolute; margin:auto; max-width:100%; max-height:100%; vertical-align:middle;\">");
		out.println("			</div>");
		out.println("			<h5 class=\"card-title mt-3\"><a href=\"ProductDetail.jsp?product_id="+obj.get_product_id()+"\">"+ obj.get_product_name() +"</a></h5>");		
		out.println("			<font size=\"4\"><b>Price</b></font> : <font color=\"#ffc107\"><b>Rs. "+ obj.get_price() +"</b> </font><br> ");
        out.println("			<b>Seller</b> : <a href=\"Seller.jsp?revhyp="+obj.get_seller_id()+"\">"+obj.get_seller_name()+"</a><br><br>");
		if(obj.get_used()<12){
			out.println("			<b>Used</b> : "+obj.get_used()%12 +" Months" );												
		}
		else{
			out.println("			<b>Used</b> : "+ obj.get_used()/12+" Years "+obj.get_used()%12 +" Months" );												
		}
		out.println("		</div>");
		out.println("	</div>");
		out.println("</div>");
		...
		if(i%3 == 0){
			out.println( "</div>");
			out.println( "<div class=\"row t-in mt-4\">");
		} 
	}
...
%>
						...
						<!-- cat_electronics ends -->
						
<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
		<div class="menu-grids mt-4">

	<%
		List<item_details> l_cycles=Home.top_hits_cycle();
	%>
								<div class="row t-in">
								<!-- content -->
<%  // for 
	System.out.println(l_cycles.size());								
	for(int i=1;i<=l_cycles.size();i++){
		item_details obj=l_cycles.get(i-1);
...
<div class="tab-pane fade" id="pills-edit" role="tabpanel" aria-labelledby="pills-edit-tab">
							<div class="menu-grids mt-4">
									...
									<%
		List<item_details> l_food=Home.top_hits_food();
	%>
								<div class="row t-in">
								<!-- content -->
<%  // for 
	System.out.println(l_food.size());								
	for(int i=1;i<=l_food.size();i++){
		item_details obj=l_food.get(i-1);
...
<div class="tab-pane fade" id="pills-mattress" role="tabpanel" aria-labelledby="pills-edit-tab">
							<div class="menu-grids mt-4">
								
									<%
		List<item_details> l_mattress=Home.top_hits_mattress();
	%>
								<div class="row t-in">
								<!-- content -->
<%  // for 
	System.out.println(l_mattress.size());								
	for(int i=1;i<=l_mattress.size();i++){
		item_details obj=l_mattress.get(i-1);
...
<div class="tab-pane fade" id="pills-books" role="tabpanel" aria-labelledby="pills-edit-tab">
							<div class="menu-grids mt-4">
								
									<%
		List<item_details> l_book=Home.top_hits_books();
	%>
								<div class="row t-in">
								<!-- content -->
<%  // for 
	System.out.println("booksize is ::::: " +l_book.size());								
	for(int i=1;i<=l_book.size();i++){
		item_details obj=l_book.get(i-1);
...
<div class="tab-pane fade" id="pills-others" role="tabpanel" aria-labelledby="pills-edit-tab">
							<div class="menu-grids mt-4">
								
									<%
		List<item_details> l_other=Home.top_hits_others();
	%>
								<div class="row t-in">
								<!-- content -->
<%  // for 
	System.out.println(l_other.size());								
	for(int i=1;i<=l_other.size();i++){
		item_details obj=l_other.get(i-1);
